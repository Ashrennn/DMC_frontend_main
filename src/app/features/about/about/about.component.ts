...
@Component({
  ...
  template: `
    <div class="about-container" [class.rtl]="isRTL">
      <!-- Hero Section -->
      <section class="hero-section">
        ...
        <div class="hero-content">
          <div class="hero-badge">
            <mat-icon class="badge-icon">history</mat-icon>
            <span class="badge-text">{{ getBadgeText() }}</span>
          </div>
          <h1 class="hero-title">{{ getHeroTitle() }}</h1>
      ...
      <section class="navigation-section">
        <div class="nav-container">
          <nav class="about-nav">
            <a routerLink="/home/about/our-history" 
               routerLinkActive="active" 
               class="nav-item">
              <mat-icon>timeline</mat-icon>
              <span>{{ getNavText('history') }}</span>
            </a>
            <a routerLink="/home/about/what-we-do" 
               routerLinkActive="active" 
               class="nav-item">
              <mat-icon>business_center</mat-icon>
              <span>{{ getNavText('what-we-do') }}</span>
            </a>
            <a routerLink="/home/about/our-people" 
               routerLinkActive="active" 
               class="nav-item">
              <mat-icon>people</mat-icon>
              <span>{{ getNavText('our-people') }}</span>
            </a>
            <a routerLink="/home/about/our-values" 
               routerLinkActive="active" 
               class="nav-item">
              <mat-icon>favorite</mat-icon>
              <span>{{ getNavText('our-values') }}</span>
            </a>
          </nav>
        </div>
      </section>
  ...
  styles: [`
    ...
    .hero-background {
      ...
      right: 0;
      bottom: 0;
      background: linear-gradient(135deg, #001B3F 0%, #002960 50%, #003d80 100%);
...
export class AboutComponent implements OnInit {
  ...
  getBadgeText(): string {
    return this.isRTL ? 'تاريخنا' : 'Our Story';
  }

  getHeroTitle(): string {
    return this.isRTL ? 'تعرف على تاريخنا' : 'Discover Our History';
  }
